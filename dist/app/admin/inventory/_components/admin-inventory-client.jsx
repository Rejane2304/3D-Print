...
export default function AdminInventoryClient() {
    ...
    return (<div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={fetchInventory} className="inline-flex items-center gap-2 px-3 py-2 text-sm rounded-lg border border-border hover:bg-bg-tertiary transition">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (<tr>
                ...
                </tr>) : (products.map((p) => (<tr key={p.id} className="border-t border-border/60">
