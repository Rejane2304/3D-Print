...
export async function GET() {
  try {
    ...
    allItems.forEach((item) => {
      ...
      if (zCm <= 5) buckets['0-5 cm'] += 1;
      else if (zCm <= 10) buckets['5-10 cm'] += 1;
      else if (zCm <= 15) buckets['10-15 cm'] += 1;
      else if (zCm <= 20) buckets['15-20 cm'] += 1;
      else if (zCm <= 25) buckets['20-25 cm'] += 1;
      else buckets['25+ cm'] += 1;
    });
